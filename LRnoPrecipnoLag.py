...
try:
    # IMPORTANT: Ensure this file contains your small dataset (e.g., 14 years of data)
    full_df = pd.read_excel("C:/Users/samam/OneDrive/MSC Diss/hacking/MSCCode/historicalDataGlomfjord.xlsx")
    if len(full_df) >= 15:
        print(f"Warning: Dataset has {len(full_df)} years. This script is optimized for < 15 years.")
        
    ## FIX: Drop rows with any missing values from the source file immediately after loading. ##
