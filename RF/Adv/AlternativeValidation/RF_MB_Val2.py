...
# Use double brackets [['massBalance']] to ensure X_hist is a DataFrame.
X_hist = full_df[features]
y_hist = full_df['energyProduction']
...
try:
    ...
    plt.title('RF Hydropower Forecast with No Precipitation or Lag Time')
    plt.grid(True)
    plt.legend()
    plt.show()
