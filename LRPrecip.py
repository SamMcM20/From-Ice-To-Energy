...
# We use the absolute value of the coefficients for ranking importance
...
try:
    ...
    # Proactively fill any potential NaNs in the source data from the Excel file
    ...
    ## FIX: Use the last known, clean values from the development set to fill the gap ##
